...
var tooltip = (function (v) {
  ...
  var Nb = function (a) {
    ...
    cc = function (a, d, c, g) {
      ...
      if (f) {
        clearInterval(a["t" + d]);
        g && g();
      } else if (d == r) X(a, a.op + (c ? 0.06 : -0.06));
      else {
        b = b + (c - b) / 3;
    ...
    ac = function (r, j, q) {
      ...
      var h = d[cb]("img");
      h && h[f] && h[0][m];
      d[e][y] = d[w] + (g ? 0.3 : 0) + "px";
      d[e][I] = d[m] + (g ? 0.3 : 0) + "px";
      d[e][o] = d[e][p] = "auto";
    ...
    Sb = function () {
      if (document.styleSheets && document.styleSheets.length) {
        ...
        c.insertRule(d, 0);
        var e =
          "#tooltipAjaxSpin {margin:30px;font-size:0;width:20px;height:20px;border-width:3px;border-color:rgba(255,255,255,.8);border-style:solid;border-top-color:black;border-right-color:rgba(0,0,0,.8);border-radius:50%;" +
          a +
          "animation:mcttSpinner .6s linear infinite;}";
        c.insertRule(e, 0);
      }
    },
    s = null,
        ...
        s.onreadystatechange = function () {
          if (s && s.readyState === 4) {
            if (s.status === 200) {
              if (k == d) {
                var j =
                    c.toLowerCase() == "xml" ? s.responseXML : s.responseText,
                  l = j;
    ...
    Ib = function () {
      ...
      c[Q] =
        '<div id="mcTooltip"><div>&nbsp;</div></div><div id="mcttCo"><b></b></div><div id="mcttCloseButton"></div>';
      x = q.body;
      j = x;
      j[z](c);
      a.a = v.license || "4321";
      ...
      var d = function (a) {
        ...
        V &&
          c.v === 0 &&
          a.target == k &&
          k.dispatchEvent(new MouseEvent("mouseover"));
      };
      fb(q, "click", d);
      fb(q, "touchstart", d);
      X(c, 0);
    ...
    Pb = function () {
      ...
      if (C.a) {
        var a = "#mcttCloseButton",
          b =
            "position:absolute;left:auto;cursor:pointer;top:" +
            v[M] +
            "px;right:" +
            v[M] +
            "px;";
        if ("insertRule" in C.a) {
          Bb(a + "{" + b + "}");
          Bb(
            "#mcttCloseButton::after{content:'+';display:block;position:absolute;__transform:rotate(45deg);}"
          );
        } else {
          C.a.addRule(a, b, 0);
          C.a.addRule(
            "#mcttCloseButton:after",
            "content:'X';display:block;position:absolute;",
            0
          );
        }
      }
    ...
    hb = function (c, b, d, f, g) {
      ...
      b[e].webkitTransform = b[e].transform =
        "translate(" + f + "px," + g + "px) rotate(" + d + "deg)";
    },
    Rb = function (h, g, c, d) {
      var f = K(0),
        e = K(1),
  ...
  Ib.prototype = {
    j: function () {
      if (
        typeof h[e].transform == "undefined" &&
    ...
    k: function () {
      ...
      ).apply(this, [a, P, ib, fc, Kb, dc, t, gc, jb]);
    },
    n: function (k, C, u) {
      var q = x;
      if (u == 2) {
        var D = t(W, C),
          B = D[cb]("*"),
          E = B[f];
        while (E--) if (B[E].type == "submit") q = yb(D);
      }
      if (j != q) {
        j = q;
        j[z](c);
    ...
    p: function (b, t, s) {
      ...
      return { x: c + q + b.offsetX, y: d + r + b.offsetY };
    },
    u: function (f, c, e, d) {
      i(h, f < 4);
      var b = [0, 0];
