...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='reply',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='bijlagetoreply', to='syntrus.commentreply'),
        ),
        migrations.AlterField(
            model_name='commentreply',
            name='commentphase',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reply', to='syntrus.frozencomments'),
        ),
        migrations.AlterField(
            model_name='commentreply',
            name='gebruiker',
        ...
        migrations.AlterField(
            model_name='commentreply',
            name='status',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reply', to='syntrus.commentstatus'),
        ),
        migrations.AlterField(
