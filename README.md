...
# Usage
## Starting off
- Add rules in the Keuzematrix (the items in the dropdown menu at the exporting page)
- Add rules in the Programma van Eisen bewerker, allocating them to items in the Keuzematrix.
- Generate your PvE PDF

When a Keuzematrix-rule in the exporter is chosen, all rules of the PvE allocated to that Keuzematrix-rule are exported.
